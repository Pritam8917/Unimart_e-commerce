  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-15 py-8">
        <Button variant="ghost" onClick={() => router.back()} className="mb-6 hover:bg-[#FF6E42] hover:text-white">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-3 mb-8">
              <Button size="lg" className="flex-1  bg-[#08A0AA] text-white hover:bg-[#20A9B2]" onClick={handleAddToCart}>
                <ShoppingCart className="w-5 h-5 mr-2 " />
                Add to Cart
              </Button>
              <Button size="lg" variant="outline" className="hover:bg-[#FF6E42] hover:text-white">

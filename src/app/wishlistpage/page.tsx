...
const WishlistPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col ">
      <Navbar />
      <CategoryNav />
      <main className="flex-1 container mx-auto px-15 py-8">
        <div className="mb-8">
        ...
        {wishlistItems.length === 0 ? (
          <div className="text-center py-16">
            ...
            <Link href="/">
              <Button className="bg-[#08A0AA] text-white hover:bg-[#20A9B2] cursor-pointer">Start Shopping</Button>
            </Link>
          </div>
        ) : (
              ...
              >
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex gap-2">
                    {/* Add to Cart Button */}
                    <Button
                      className="flex-1 bg-[#08A0AA] text-white hover:bg-[#20A9B2] transition-colors cursor-pointer"
